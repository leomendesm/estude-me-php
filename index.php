        ...
        <nav class="white" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    <div id='nlog'>
                        <li><a id="abrelogin1" href='#'>Área do Aluno</a></li>
                    </div>
                    <div id='log'>
                        ...
                        <div class="col s12 m4">
                            <div class="card big">
                                ...
                                <div class="card-action center">
                                    ...
                                    <br>
                                    <a href='show.php?materia=biologia&frente=3'>Frente 3</a>
                                    <a href='show.php?materia=biologia&frente=4'>Frente 4</a>
                                    <br>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 m4">
                            <div class="card big">
                                ...
                                <div class="card-action center">
                                    ...
                                    <a href='show.php?materia=matematica&frente=2'>Frente 2</a>
                                    <br>
                                    <a href='show.php?materia=matematica&frente=3'>Frente 3</a>
                                    <a href='show.php?materia=matematica&frente=4'>Frente 4</a>
                                    <br>
                                </div>
                            </div>
                        </div>
