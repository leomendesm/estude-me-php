                ...
                <div class="row" id="register">
                    <form id="formregister" class="col s12">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6">
                                <input id="rnome" type="text" class="validate" name="email" autofocus placeholder="Ex:Maria, João">
            ...
            <div id="index-banner" class="parallax-container mainpage">
                <div class="section no-pad-bot">
                    <div class="container">
                        ...
                        <div class="row center">
                            <a data-target='modal' href='#modal2' class=" modal-trigger btn-large waves-effect waves-light red lighten-1">Começe agora</a>
                        </div>
                        <br>
                        <br>
